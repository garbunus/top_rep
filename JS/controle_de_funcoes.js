...
function escreve_arg_grava_repositorio(id, commits, contributors, name, language, description, html_url, url, created_at, forks){
  $('#bt_grava_repositorio').attr('onclick','grava_repositorio(' + id + ', ' + commits + ', ' + contributors + ', \'' + name + '\',\'' + language + '\', \'' + description + '\', \'' + html_url + '\', \'' + url + '\', \'' + created_at + '\', ' + forks + ')');
}

//altera argumento da função "detalhe_repositorio()", setando qual repositorio deve ser visualizado
function escreve_arg_detalhe_repositorio(id, commits, contributors, name, language, description, html_url, url, created_at, forks){
  $('#bt_detalhe_repositorio').attr('onclick','detalhe_repositorio('+ id + ',' + commits + ',' + contributors + ', \'' + name + '\', \'' + language + '\', \'' + description + '\', \'' + url + '\', \'' + created_at + '\', ' + forks + ')');
}
